...
Sin esto, no podés construir ERP.
Sin esto, no podés garantizar contabilidad.

Este módulo SIEMPRE VA PRIMERO.

📘 2) NEGOCIO (ERP Operativo)
...
Este módulo SIEMPRE VA DESPUÉS DEL NÚCLEO
y SIEMPRE VA ANTES de la contabilidad.

Si lo invertís → te explota la consistencia temporal.

📙 3) CONTABILIDAD (ACCCORE – Fase 3)
📌 Interpreta los eventos operativos del ERP y produce información contable real.
...
NUNCA se generan asientos directamente desde módulos operativos.
